...
<head>
  ...
  <link rel="stylesheet" href="css/style_2.css">
   <script>
      function myFun()
      {
                var str = "three.jsp?cgpa="+ document.forms["ns"]["cgpa"].value;
...
<body>
    ...
    ResultSet rs =  re.executeQuery("Select REGISTERNUMBER,NAME,CGPA,MAILID from StudentCSE where YR = 3 ORDER BY REGISTERNUMBER");
    while(rs.next())
    {
    ...
    ResultSet rd =  re.executeQuery("Select REGISTERNUMBER,NAME,CGPA,MAILID from StudentCSE where Yr = 3 ORDER BY CGPA DESC");
    while(rd.next())
    {
