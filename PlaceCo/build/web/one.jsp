...
<center><h1 style="font-family: sans-serif; font-size: 20px">FIRST YEAR</h1></center>
    ...
    PreparedStatement ps = conn.prepareStatement("Select REGISTERNUMBER,NAME,CGPA,MAILID from StudentCSE where YR = 1 AND CGPA > ?");
