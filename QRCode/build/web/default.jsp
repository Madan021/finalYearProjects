...
<div class="wrap">
  ...
  <div class="flip-container" id='flippr'>
    <div class="flipper">
        <div class="front">
            <img src="advertisement-banner-img.png" alt=""/>
        </div>
      <div class="back"></div>
    </div>
  </div>

  <h1 class="text" id="welcome">Nanga Irukom....!</h1>
<span>Please login...</span><br>
<span style=color:red>INVALID USERNAME OR PASSWORD</span>
  <form action='validate.do' method='post' id="theForm">
