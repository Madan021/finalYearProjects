...
<center><h1 style="font-family: sans-serif; font-size: 20px">Fourth Year</h1></center>
    ...
    PreparedStatement ps = conn.prepareStatement("Select REGISTERNUMBER,NAME,CGPA,MAILID from StudentCSE where YR = 4 AND CGPA > ?");
